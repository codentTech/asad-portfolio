        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            >
              {whyContact.map((item, index) => (
                ...
                >
                  ...
                  <h3 className="text-base font-bold text-[#ccd6f6] mb-1.5">{item.title}</h3>
                  <p className="text-xs sm:text-sm text-[#8892b0] leading-relaxed">{item.description}</p>
                </motion.div>
              ))}
            </motion.div>
            ...
            {/* Contact Form */}
              ...
              >
                <div className="bg-[#112240] border border-[#233554] rounded-lg p-6">
                  <h3 className="text-xl font-bold mb-2 text-[#ccd6f6]">Send a Message</h3>
            ...
            {/* Contact Info */}
              ...
              >
                <div className="bg-[#112240] border border-[#233554] rounded-lg p-6">
                  <h3 className="text-xl font-bold mb-4 text-[#ccd6f6]">Contact Information</h3>
