          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  href="/services"
                  className="inline-flex items-center px-6 py-3 border-2 border-[#64ffda] text-[#64ffda] font-mono text-xs sm:text-sm rounded transition-all hover:bg-[#64ffda]/10"
                >
                  View Services
                </Link>
              </div>
