...
export default function AboutPageClient() {
  ...
  return (
    <div className="min-h-screen bg-[#0a192f] pt-20">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              >
                <div className="relative rounded-lg overflow-hidden border-2 border-[#64ffda]/20">
                  <div className="relative w-full aspect-square overflow-hidden bg-[#112240]">
                    <img
                  ...
                  <div className="absolute inset-0 border-2 border-[#64ffda] rounded-lg translate-x-4 translate-y-4 -z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
                </div>
              </motion.div>
              ...
              >
                <div>
                  ...
                  <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-[#ccd6f6]">
                    Hi, I&apos;m{" "}
                    <span className="text-[#64ffda]">Asad Abbas</span>
                  </h1>
                </div>
                <p className="text-lg text-[#8892b0] leading-relaxed mb-4">
      ...
      {/* Stats */}
      <section ref={ref} className="py-20 bg-[#020c1b]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                >
                  <div className="text-3xl sm:text-4xl font-bold text-[#64ffda] mb-2">
                    {stat.value}
                  </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#ccd6f6] mb-4">
            ...
            <div className="space-y-8">
              {experiences.map((exp, idx) => (
                <motion.div
                  ...
                  className="bg-[#112240] border border-[#233554] rounded-lg p-8 hover:border-[#64ffda] transition-all duration-300"
                >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <ul className="space-y-2 mb-4">
                        {exp.description.map((item, i) => (
                          <li
                            key={i}
                            className="text-[#8892b0] flex items-start text-sm sm:text-base"
                          >
            ...
            <div className="space-y-12">
              {Object.entries(skillCategories).map(
                ([category, categorySkills], catIdx) => (
                  ...
                  >
                    <h3 className="text-2xl font-bold mb-6 capitalize text-[#ccd6f6] font-mono">
                      {category}
                    </h3>
                      ...
                      {categorySkills.map((skill, skillIdx) => (
                        ...
                        >
                          <div className="flex justify-between items-center">
                            <span className="text-base font-medium text-[#ccd6f6]">
                              {skill.name}
                            </span>
                            <span className="text-sm text-[#8892b0] font-mono">
                              {skill.level}%
